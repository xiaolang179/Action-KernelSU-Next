...
# Action-Build-KernelSU Next
**```Build All OnePlus Devices KernelSU Next Kernel```**
>更高效 更全面 更快速 更稳定
...
>
>请fork本分支项目``Numbersf/Action-Build-KernelSUNext``而不是原项目或者其他项目 其他并不适配你这个机型  
>
...
```
AnyKernel3_KernelSUNext_12896_oneplus_ace2pro_Android15.0.0_KPM_VFS.zip
AnyKernel3_KernelSUNext_12896_oneplus_13_Android15.0.2_KPM_VFS.zip
AnyKernel3_KernelSUNext_12896_oneplus_11_Android14.1.0_KPM_VFS.zip
``` 
